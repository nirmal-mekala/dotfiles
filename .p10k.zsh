# Generated by Powerlevel10k configuration wizard on 2022-09-12 at 14:22 CDT.
...
# 12h time, 1 line, compact, few icons, concise, instant_prompt=quiet. Type `p10k configure` to generate another config.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a %b %-d} %D{%I:%M %p}'
